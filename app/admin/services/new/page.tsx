...
export default function NewServicePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          title: "Dienst succesvol toegevoegd!",
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-900">Nieuwe Dienst Toevoegen</h1>
                  <p className="text-sm text-gray-500">Voeg een nieuwe dienst toe aan de website</p>
                </div>
              </div>
            </div>
          </div>
