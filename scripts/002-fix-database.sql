-- ============================================================
-- 002-fix-database.sql
-- Gebruik: Database volledig opnieuw opbouwen (verwijdert alle tabellen en data).
-- Run dit alleen als je een schone lei wilt. Daarna opnieuw occasions toevoegen via admin.
-- ============================================================
...
-- Geen sample data. Occasions toevoegen via admin panel.
